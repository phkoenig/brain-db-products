...
interface ProductEditorProps {
  ...
  product?: any; // TODO: Define proper product type
}

function ProductEditor({ open, onOpenChange, product }: ProductEditorProps) {
  return (
    <DrawerLayout open={open} onOpenChange={onOpenChange}>
      <div className="flex h-full w-full flex-col items-start gap-4 bg-default-background px-4 py-4">
        <div className="flex w-full grow shrink-0 basis-0 items-start gap-4">
          <div className="hidden grow shrink-0 basis-0 flex-col items-start gap-2 self-stretch rounded-lg border border-solid border-neutral-border bg-default-background px-2 py-2 shadow-md">
            ...
            <div className="flex w-full flex-col items-start gap-2">
              ...
              <div className="flex w-full flex-col items-start gap-1 pt-4">
                ...
                <ToggleGroup value="" onValueChange={(value: string) => {}}>
                  <ToggleGroup.Item value="bc2d075a">1</ToggleGroup.Item>
                  <ToggleGroup.Item value="ca2a6e32">2</ToggleGroup.Item>
                  <ToggleGroup.Item value="4d8efef1">3</ToggleGroup.Item>
                  <ToggleGroup.Item value="6ce82e3c">4</ToggleGroup.Item>
                  <ToggleGroup.Item value="ec5957a4">5</ToggleGroup.Item>
                </ToggleGroup>
              </div>
              <div className="flex w-full flex-col items-start gap-1 pt-4">
                <span className="whitespace-pre-wrap text-caption font-caption text-default-font">
