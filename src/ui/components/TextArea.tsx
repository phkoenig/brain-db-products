    ...
    return (
      ...
      >
        ...
        {children ? (
          <div
            className={SubframeUtils.twClassNames(
              "flex w-full grow shrink-0 basis-0 flex-col items-start rounded-md border-2 border-solid border-neutral-border bg-default-background pl-1 group-focus-within/4ec05ee8:border-2 group-focus-within/4ec05ee8:border-solid group-focus-within/4ec05ee8:border-brand-primary",
              {
